                    ...
                    <CardHeader className="sm:px-8 sm:pt-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                                ...
                                <CardDescription className="truncate">Editing "{product.name}"</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                    <CardContent className="sm:px-8 sm:pb-8">
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <ProductFormFields data={data} setData={setData} errors={errors} categories={categories} units={units} isEdit />
                ...
                <div className="rounded-xl border bg-muted/30 p-3">
                    <div className="flex items-start justify-between gap-2">
                        <div className="flex min-w-0 items-start gap-2.5">
                            ...
                            <div className="min-w-0">
                                <p className={cn('truncate font-medium', !name && 'text-muted-foreground italic')}>{name || 'Untitled product'}</p>
                                {categoryName && (
