                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle className="text-lg">Add Recurring Bill</CardTitle>
                                <CardDescription>
                                    For bills that repeat every month, like rent, electricity, water, or internet.
                                    You'll get a reminder each month instead of re-entering it from scratch.
                                </CardDescription>
                            </div>
                        </div>
                    </CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            {isOwner && (
                                <div>
                                    ...
                                    >
                                        <SelectTrigger id="location_id" className="mt-1.5 w-full">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    />
                                    {errors.estimated_amount && <p className="mt-1 text-sm text-red-600">{errors.estimated_amount}</p>}
                                </div>
                                <div>
                                    <Label htmlFor="day_of_month">Due Day *</Label>
                                    <Input
                                        id="day_of_month"
                                        type="number"
                                        inputMode="numeric"
                                    ...
                                    />
                                    {errors.day_of_month && <p className="mt-1 text-sm text-red-600">{errors.day_of_month}</p>}
                                </div>
                            </div>
                            <p className="-mt-2 text-xs text-muted-foreground">
                                A typical amount and due day — you can adjust the actual figure each month when you pay it.
                            </p>
