...
export default function SuppliersIndex({
    ...
    function handleDelete(supplier: Supplier) {
        if (
            confirm(
                `Remove supplier "${supplier.name}"? This cannot be undone.`,
            )
        ) {
    ...
    const filtered = useMemo(() => {
        ...
        return supplierList.filter((s) =>
            [s.name, s.contact_person, s.phone, s.email].some((f) =>
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-muted-foreground">
                            Manage the vendors you receive stock from.
                        </p>
                    </div>
                    <Button
                        asChild
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed py-16 text-center">
            ...
            <p className="max-w-xs text-sm text-muted-foreground">
                Add your first supplier to start receiving stock from them.
            </p>
            <Button
                asChild
                size="sm"
...
function NoResults({ onClear }: { onClear: () => void }) {
    return (
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed py-16 text-center">
            ...
            <p className="max-w-xs text-sm text-muted-foreground">
                Try a different name, contact, phone, or email.
            </p>
            <Button
                variant="outline"
                size="sm"
