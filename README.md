...
> **New to this project, or new to installing developer software in general?** Skip straight to
> [`GETTING_STARTED.md`](GETTING_STARTED.md) — a step-by-step install and usage guide written
> for someone with no technical background. Everything below is the quicker technical version.
