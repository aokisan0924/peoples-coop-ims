...
class DashboardController extends Controller
{
    ...
    /**
     * @return Collection<int, array{id: int, product_name: string, remaining_qty: int, expiry_date: string, days_left: int}>
     */
    private function expiringSoon(Carbon $today, ?int $locationId): Collection
    {
     ...
     */
    private function trend(Carbon $today, int $days, ?int $locationId): Collection
    {
     ...
     */
    private function paymentBreakdown(Carbon $today, ?int $locationId): \Illuminate\Database\Eloquent\Collection
    {
     ...
     * @return \Illuminate\Database\Eloquent\Collection<int, Sale>
     */
    private function cashierBreakdown(Carbon $today, ?int $locationId): \Illuminate\Database\Eloquent\Collection
    {
    ...
    /**
     * @return Collection<int, object{name: string, units_sold: float|int, revenue: float|int}>
     */
    private function bestSellers(Carbon $today, ?int $locationId): Collection
    {
     ...
     *
     * @return array<int, array{location_id: int, location_name: string, balance: float, today_cash_in: float, today_cash_out: float}>
     */
    private function gcashOverview(Carbon $today, ?int $locationId): array
    {
     ...
     *
     * @return array{total_unpaid: float, unpaid_count: int, overdue_count: int, upcoming: Collection<int, array{id: int, supplier_name: string, amount: float, due_date: string|null, is_overdue: bool}>}
     */
    private function payablesSummary(Carbon $today, ?int $locationId): array
    {
     ...
     *
     * @return Collection<int, array{id: int, cashier_name: string, location_name: string, starting_cash: float, opened_at: string}>
     */
    private function openShifts(?int $locationId): Collection
    {
